...
function main() {
    ...
    webglUtils.resizeCanvasToDisplaySize(canvas.c);
    ...
    texcanvas.width = 32; texcanvas.height = 128;
    tex = texcanvas.getContext('2d');
    tex.fillStyle = "#f00";
    tex.fillRect(0,0,32,32);
    tex.filLStyle = "#0f0";
    tex.fillRect(0,64,32,32);
    tex.fillStyle = "#ff0";
    tex.fillRect(0,32,32,32);
    tex.fillStyle = "#00f";
    tex.fillRect(0,96,32,32);
    ...
    function create() {
        ...
        for (var i = 0; i < startBunnyCount; i++) {
            ...
            kitten.speedX = Math.random() * 3;
            kitten.speedY = (Math.random() * 3) - 1.5;
        ...
        if (add) {
            if (count < 200000) {
                ...
                for (var i = 0; i < amount; i++) {
                    ...
                    kitten.speedX = Math.random() * 3;
                    kitten.speedY = (Math.random() * 3) - 1.5;
                    kitten.rotation = (Math.random() - 0.2);
                    kittens[count++] = kitten;
                }
                counter.innerHTML = count + " KITTENS";
            }
...
//kittenImage.src = 'data:image/png;base64,';
    kittenImage.src = texcanvas.toDataURL();
